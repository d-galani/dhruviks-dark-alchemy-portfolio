  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <motion.div 
        ...
        style={{ y: backgroundY }}
      >
        <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-purple-900/10 opacity-95" />
        ...
        <motion.div
          className="absolute top-1/4 left-1/4 w-64 h-64 bg-purple-500/3 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.2, 0.4, 0.2],
          }}
